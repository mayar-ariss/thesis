...
function [successOutput, XPiers_filtered, YPiers_filtered, ZPiers_filtered, XSpandrels_filtered, YSpandrels_filtered, ZSpandrels_filtered, XNodes_filtered, YNodes_filtered, ZNodes_filtered] = drawModelTremuri( model, varargin )

%[successOutput, XPiers_filtered, YPiers_filtered, ZPiers_filtered, XSpandrels_filtered, YSpandrels_filtered, ZSpandrels_filtered, XNodes_filtered, YNodes_filtered, ZNodes_filtered]=drawModelTremuri(readTremuriInput('tremuri2.txt'), 'ColorPiers', [0.2 0.2 1.0], 'ColorSpandrels', [0.2 1. .2], 'styleNodes', 'sk')
